...
function ExperienceCard({ experience, index }: { experience: ExperienceItem; index: number }) {
    ...
    const getTypeColor = (type: string) => {
        switch (type) {
            ...
            case "certification": return "warning";
            ...
            <div className="flex flex-col items-center">
                <div className={`w-4 h-4 rounded-full ${
                    experience.type === 'work' ? 'bg-primary' :
                        experience.type === 'education' ? 'bg-success' :
                            'bg-warning'
            ...
            <div className="space-y-12">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-lg text-default-500 max-w-2xl mx-auto">
                        My professional journey in cybersecurity, from learning the fundamentals to hunting vulnerabilities
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto pt-8">
                    <div className="text-center p-6 bg-background/60 dark:bg-default-100/50 rounded-lg">
                        ...
                        <div className="text-sm text-default-500 mt-2">Work Experiences</div>
                    </div>
                    ...
                    <div className="text-center p-6 bg-background/60 dark:bg-default-100/50 rounded-lg">
                        ...
                        <div className="text-sm text-default-500 mt-2">Years Experience</div>
                    </div>
                </div>
