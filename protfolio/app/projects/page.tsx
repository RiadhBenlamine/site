      ...
      <div className="space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-default-500 max-w-2xl mx-auto">
            Security tools, exploits, and research projects I've built to
            enhance penetration testing and vulnerability discovery
          </p>
        </div>
        ...
        <div className="text-center pt-8">
          <p className="text-default-500 mb-4">Want to see more of my work?</p>
          <Button
            as={Link}
